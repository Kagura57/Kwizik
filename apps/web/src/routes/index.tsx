  ...
  return (
    <section>
      ...
      <p id="status" style={{ marginTop: 12, color: "#444" }}>
        ...
        {createRoomMutation.isSuccess && `Room créée (${createRoomMutation.data.source}) : ${createRoomMutation.data.roomCode}`}
        {createRoomMutation.isError && "Erreur pendant la création de la room."}
        {!createRoomMutation.isPending && !createRoomMutation.isSuccess && !createRoomMutation.isError && "En attente d'action..."}
      </p>
    </section>
  );
}
